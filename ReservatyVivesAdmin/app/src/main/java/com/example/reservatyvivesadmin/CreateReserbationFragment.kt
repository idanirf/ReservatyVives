 ...
 * Use the [CreateReserbationFragment.newInstance] factory method to
...
class CreateReserbationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CreateReserbationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CreateReserbationFragment().apply {
